...
// I don't think Either is a good example of a traversable
// test ("Algebraic: reduce")
//   (() =>
//     assertEquivalent
//       ("All of the container's value is multiplied by two; passing all the arguments at once.")
//       (reduce ((xs,  x) => [ ...xs, x + 2 ]) ([]) ([  102, 117, 103, 97 ]))
//       ([ 104, 119, 105, 99 ]) ||
//     assertEquivalent
//       ("All of the container's value is multiplied by two; passing all the arguments one at a time.")
//       (reduce (xs => x => [ ...xs, x + 2 ]) ([]) ([  102, 117, 103, 97 ]))
//       ([ 104, 119, 105, 99 ]) ||
//     assertEquivalent
//       ("All of the container's value is multiplied by two; passing a custom combinator.")
//       (reduce (accumulate (x => x + 2)) ([]) ([  102, 117, 103, 97 ]))
//       ([ 104, 119, 105, 99 ])
//   );
